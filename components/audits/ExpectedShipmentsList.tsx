    ...
    return (
        <Card className="flex flex-col h-full rounded-none border-border bg-background overflow-hidden">
            ...
            <div className="p-4 border-b border-border/50 flex justify-between items-center bg-muted/5 z-10">
                <h3 className="text-sm font-bold uppercase tracking-widest text-foreground">Consignment Tally</h3>
            ...
            <div className="flex-1 overflow-y-auto p-2">
                {filteredItems.length === 0 ? (
                    <div className="h-full flex flex-col items-center justify-center text-muted-foreground space-y-4">
                        ...
                        <p className="text-xs uppercase tracking-widest font-mono">No {filter !== 'ALL' ? filter.toLowerCase() : ''} consignments found</p>
                    </div>
                ) : (
                        ...
                        <AnimatePresence>
                            {filteredItems.map(item => (
                                <motion.li
                                    ...
                                    className={`p-4 border flex justify-between items-center ${item.status === 'SCANNED'
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-xs text-muted-foreground flex gap-2 items-center mt-1">
                                                <span className="truncate max-w-[150px]">{item.shipment.consignee_name}</span>

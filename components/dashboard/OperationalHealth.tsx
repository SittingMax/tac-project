    ...
    const healthData = useMemo(() => {
        ...
        return {
            ...
            metrics: [
                ...
                { label: 'Exception Drag', value: exceptionPenalty, icon: AlertCircle, target: 0, invert: true },
            ]
        };
    }, [data]);
        ...
        <Card className="h-[420px] border-border/50 flex flex-col p-6 bg-card relative overflow-hidden">
            ...
            <div className="space-y-4 mt-6">
                {healthData.metrics.map((metric, i) => (
                    <div key={i} className="flex flex-col gap-1.5 cursor-help group" title="Score breakdown contribution">
                        <div className="flex justify-between items-center text-sm">
                            ...
                            <span className="font-semibold font-mono">
                                {metric.value}{metric.invert ? ` pts` : '%'}
                            </span>
                        </div>
                        <Progress

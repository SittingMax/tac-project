                    ...
                    <CardTitle className="flex justify-between items-center">
                        ...
                        <Select value={timeRange} onValueChange={setTimeRange}>
                            ...
                            <SelectContent className="rounded-none">
                                <SelectItem value="90d" className="rounded-none text-xs">Last 90 days</SelectItem>
                                <SelectItem value="30d" className="rounded-none text-xs">Last 30 days</SelectItem>
                                <SelectItem value="7d" className="rounded-none text-xs">Last 7 days</SelectItem>
                            </SelectContent>
                        </Select>
                    </CardTitle>
                    <CardDescription>Daily financial performance</CardDescription>

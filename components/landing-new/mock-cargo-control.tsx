                ...
                <div className="flex-1 flex flex-col relative">
                    ...
                    <div className="h-14 border-b border-border flex items-center justify-between px-4 lg:px-6 bg-foreground/[0.01]">
                        <div className="flex gap-2.5 items-center">
                            <div className="w-3 h-3 rounded-none bg-destructive/20 flex items-center justify-center"><div className="w-1.5 h-1.5 rounded-none bg-destructive" /></div>
                            <div className="w-3 h-3 rounded-none bg-orange-500/20 flex items-center justify-center"><div className="w-1.5 h-1.5 rounded-none bg-orange-500" /></div>
                            <div className="w-3 h-3 rounded-none bg-primary/20 flex items-center justify-center"><div className="w-1.5 h-1.5 rounded-none bg-primary" /></div>
                        </div>
                        ...
                        <div className="flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-none px-3 py-1">
                            ...
                            <span className="text-[10px] font-mono text-primary uppercase tracking-wider">Live Connected</span>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 p-6 flex flex-col gap-6 relative z-10 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-foreground/[0.03] to-transparent">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                            {[
                                ...
                                <div key={i} className="rounded-none border border-border bg-foreground/[0.02] p-4 flex flex-col gap-1 backdrop-blur-md">
                                    <span className="text-xs font-mono text-foreground/40 uppercase">{stat.label}</span>
                                    <span className={`text-xl md:text-2xl font-semibold tracking-tight ${stat.color}`}>{stat.value}</span>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="flex-1 rounded-none border border-border bg-foreground/[0.01] overflow-hidden relative group">
                            <div className="absolute top-4 left-4 z-10 flex items-center gap-2">
                                ...
                                <span className="text-sm font-medium text-foreground/80">Global Telemetry Stream</span>
                            </div>

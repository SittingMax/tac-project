          ...
          <div className="relative z-10">
            ...
            <div className="mb-8 flex justify-center overflow-hidden">
              <LottieSlot
                ...
                fallbackIcon={<MapPin size={32} strokeWidth={1.5} className="text-primary opacity-50" />}
              />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <div className="flex-1 relative group">
                ...
                <Input
                  ...
                  className="h-14 pl-12 pr-4 rounded-md border border-border/50 bg-background/80 text-foreground text-base focus-visible:ring-2 focus-visible:ring-primary focus-visible:border-primary placeholder:text-muted-foreground transition hover:bg-background shadow-inner"
              ...
              <button
                ...
                className="h-14 px-10 bg-primary text-primary-foreground border border-transparent rounded-md font-semibold text-sm shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30 transition duration-300 disabled:opacity-50 flex items-center justify-center gap-3 w-full sm:w-auto hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                aria-live="polite"
              ...
              >
                ...
                {isSearching ? 'Searching…' : 'Track Entity'}
              </button>
            </div>
              ...
              <div className="flex-wrap justify-center gap-3">
                {['WGS882190', 'DEL-98234', 'IMP-45621'].map((example) => (
                  <button
                    ...
                    className="px-4 py-2 text-xs font-medium border border-border/50 rounded-md bg-muted/30 text-muted-foreground hover:text-foreground hover:border-primary/50 hover:bg-primary/5 transition focus-visible:ring-2 focus-visible:ring-primary focus-visible:focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                    type="button"
                  >
                    {example}
                  </button>

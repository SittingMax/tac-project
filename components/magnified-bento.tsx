...
// Customizable content for TAC Cargo Portal - Tracking & Logistics Focus
const TAG_ROWS: { id: string; icon: LucideIcon; label: string }[][] = [
  ...
  [
    ...
    { id: 'status-updates', icon: RefreshCw, label: 'Real-time Updates' },
...
const CONFIG = {
  ...
  description:
    'Real-time visibility into your supply chain with advanced tracking, AI-powered route optimization, and secure cargo handling.',
    ...
    <div className="flex items-center justify-center p-4 sm:p-6 w-full not-prose">
      <div className="group relative w-full max-w-[420px] overflow-hidden rounded-none sm:rounded-none.5rem] border bg-card p-1.5 sm:p-2 shadow-2xl shadow-primary/5 transition-all duration-500 hover:shadow-primary/10 hover:-translate-y-1">
        ...
        <div className="p-4 sm:p-6 px-4 pb-6 sm:pb-8">
          <h3 className="text-xl font-medium tracking-tight text-foreground">{CONFIG.title}</h3>

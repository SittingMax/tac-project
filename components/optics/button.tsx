...
const buttonVariants = cva(
  "focus-visible:border-ring focus-visible:ring-ring/30 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 border border-transparent bg-clip-padding text-xs/relaxed font-medium focus-visible:ring-[2px] aria-invalid:ring-[2px] [&_svg:not([class*='size-'])]:size-4 inline-flex items-center justify-center whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none gap-2! rounded-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 cursor-pointer aria-expanded:ring-[2px] aria-expanded:ring-ring/30",
  {
    variants: {
      variant: {
        default:
  ...
  return (
    <ButtonPrimitive
      ...
      className={cn(
        ...
        variant === 'decorations' && 'relative rounded-none squircle-none overflow-visible'
      )}
      {...props}
    >
      {children}
      {variant === 'decorations' && (
        <div className={cn('absolute -left-[1px] -top-[1px] z-10')}>
          <div className="relative">
            <div className="bg-muted-foreground w-[1px] h-[5px] rounded-none absolute top-0" />
            <div className="bg-muted-foreground w-[5px] h-[1px] rounded-none absolute left-0" />
          </div>
        </div>
      )}
      ...
      {variant === 'decorations' && (
        <div className={cn('absolute -right-[0px] -top-[1px] z-10')}>
          <div className="relative">
            <div className="bg-muted-foreground w-[1px] h-[5px] rounded-none absolute top-0" />
            <div className="bg-muted-foreground w-[5px] h-[1px] rounded-none absolute -left-[4.5px]" />
          </div>
        </div>
      )}
      ...
      {variant === 'decorations' && (
        <div className={cn('absolute -left-[1px] -bottom-[0px] z-10')}>
          <div className="relative">
            <div className="bg-muted-foreground w-[1px] h-[5px] rounded-none absolute -top-[4.5px]" />
            <div className="bg-muted-foreground w-[5px] h-[1px] rounded-none absolute left-0" />
          </div>
        </div>
      )}

    ...
    return (
      <Card className="p-8 text-center bg-card/50 border-border animate-in fade-in zoom-in">
        ...
        <p className="text-muted-foreground mb-6 max-w-md mx-auto">
          We have received your booking request. Our operations team will contact you shortly on
          your WhatsApp number to confirm pickup details.
        </p>
            ...
            <div key={idx} className="grid grid-cols-5 gap-3 p-4 bg-muted/30 rounded-none">
              <div className="space-y-1">
                ...
                <Input
                  ...
                  min="1"
                  value={pkg.quantity}
                  onChange={(e) => updatePackage(idx, 'quantity', e.target.value)}
                />
              </div>
              <div className="space-y-1">
                ...
                <Input
                  ...
                  min="1"
                  value={pkg.length}
                  onChange={(e) => updatePackage(idx, 'length', e.target.value)}
                />
              </div>
              <div className="space-y-1">
                ...
                <Input
                  ...
                  min="1"
                  value={pkg.width}
                  onChange={(e) => updatePackage(idx, 'width', e.target.value)}
                />
              </div>
              <div className="space-y-1">
                ...
                <Input
                  ...
                  min="1"
                  value={pkg.height}
                  onChange={(e) => updatePackage(idx, 'height', e.target.value)}
                />
              </div>
              <div className="space-y-1">
                ...
                <Input
                  ...
                  step="0.1"
                  value={pkg.weight}
                  onChange={(e) => updatePackage(idx, 'weight', e.target.value)}
                />
              </div>
            </div>
          ))}
      ...
      <Card className="p-6 bg-card/80 border-border">
        ...
        <div className="space-y-2 max-w-md">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            We will send tracking updates and booking confirmation to this number.
          </p>
        </div>
      </Card>

  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-none text-sm font-semibold transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        destructive:
          'bg-destructive text-destructive-foreground shadow-sm hover:shadow-md hover:-translate-y-0.5 focus-visible:ring-destructive/20',
        outline:
        ...
        success:
          'bg-status-success text-white shadow-sm hover:shadow-md hover:-translate-y-0.5 hover:bg-status-success/90',
      },
      size: {
        default: 'h-10 px-5 py-2 has-[>svg]:px-4',
        xs: "h-7 gap-1 rounded-none px-3 text-xs has-[>svg]:px-2.5 [&_svg:not([class*='size-'])]:size-3",
        sm: 'h-9 rounded-none gap-1.5 px-4 has-[>svg]:px-3.5',
        lg: 'h-12 rounded-none px-8 has-[>svg]:px-6',
        icon: 'size-10',

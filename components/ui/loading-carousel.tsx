...
export function LoadingCarousel({ tips, autoplayInterval = 5000 }: LoadingCarouselProps) {
  ...
  const plugin = React.useRef(Autoplay({ delay: autoplayInterval, stopOnInteraction: false }));
  ...
  return (
    <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 min-h-[600px] border border-dashed border-border rounded-md overflow-hidden bg-background/50 backdrop-blur-sm">

...
export function ShipmentCardSkeleton({ className }: SkeletonProps) {
  return (
    <div className={cn('rounded-none border border-border/40 bg-card p-4 space-y-3', className)}>
...
export function ScanPanelSkeleton({ className }: SkeletonProps) {
  return (
    <div className={cn('rounded-none border border-border/40 bg-card p-6 space-y-6', className)}>
      {/* Input */}
      <div className="space-y-2">
        <Skeleton className="h-4 w-20" />

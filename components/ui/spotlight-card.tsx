...
export function SpotlightCard({
  ...
  return (
    <Component
      ...
      className={cn(
        'relative overflow-hidden rounded-md border border-border/40 bg-card/20 text-card-foreground shadow-sm transition-all duration-300 hover:shadow-md hover:border-primary/50',
        className
      )}
      style={
        {

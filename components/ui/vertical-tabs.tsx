        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center order-2 lg:order-1 pt-4">
            <div className="space-y-1 mb-12">
              ...
              <h2 className="tracking-tighter text-balance text-3xl font-extrabold md:text-4xl lg:text-5xl text-foreground pb-1">
                Connecting Northeast India <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-emerald-300">
                  to the Nation.
                </span>
              </h2>
              <span className="text-[10px] font-medium text-muted-foreground uppercase tracking-[0.3em] block ml-0.5 pt-2">
                (SERVICES)
              </span>
            </div>

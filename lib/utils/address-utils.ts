 ...
 */
export const normalizeCustomerAddress = (address: CustomerAddress | Json | string | null | undefined) => {
    if (!address) return {};
 ...
 */
export const formatCustomerAddress = (address: CustomerAddress | Json | string | null | undefined): string => {
    if (!address) return '';

...
const Bookings = lazy(() =>
  import('@/pages/Bookings').then((module) => ({ default: module.Bookings }))
);
...
const ArrivalAudit = lazy(() =>
  import('@/pages/ArrivalAudit').then((module) => ({ default: module.ArrivalAudit }))
);
...
export const routes: AppRoute[] = [
  ...
  { path: '/bookings', element: Bookings, protected: true, layout: true },
  {
    ...
    protected: true,
    layout: true,
    allowedRoles: ['ADMIN', 'MANAGER', 'FINANCE_STAFF'],
  },
